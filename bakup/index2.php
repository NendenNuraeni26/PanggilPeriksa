...
<head>
    ...
    <title>Display Panggilan Periksa</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="kiri">
            <div class="card">
                ...
                <div class="judul">PANGGILAN PERIKSA</div>
    ...
    <script>
        const kd_poli = new URLSearchParams(window.location.search).get('kd_poli') || '';
        ...
        /* ================= CEK ANTRIAN (STABLE POLLING) ================= */
        function cekAntrian() {

            if (isLoading) return;
            isLoading = true;

            fetch('ambil_antrian.php?kd_poli=' + kd_poli + '&t=' + Date.now())
                .then(r => r.json())
                .then(res => {
                    ...
                    if (terakhir === data.no_rawat) {
                        isLoading = false;
                        return;
                    }

                    terakhir = data.no_rawat;
